...
class LanguagePoaModel(models.Model):
    language = models.CharField(
        max_length=30, unique=True, validators=(MinLengthValidator(3),)
    )
    short_name_language = models.CharField(
        max_length=30, unique=True, validators=(MinLengthValidator(1),)
    )
