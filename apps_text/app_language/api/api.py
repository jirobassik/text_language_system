...
from apps_text.app_language.api.schems import LanguageDet, LanguageDetFile
...
@throttle(User60MinRateThrottle, User100PerDayRateThrottle)
def lang_detect_api_file(
    request, method: Form[LanguageDetFile], file: UploadedFile = File(...)
):
