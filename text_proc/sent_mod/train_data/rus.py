sentences_pos = [
    ...
    (
        "Моя семья всегда поддерживает меня во всем, и я очень благодарен им за это.",
        "pos",
    ),
    (
    ...
    (
        "Вчера я встретил старого друга, и мы провели вечер в приятной беседе и веселье.",
        "pos",
    ),
    (
