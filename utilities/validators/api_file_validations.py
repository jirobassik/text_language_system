...
class ApiMaxLengthFileValidator(
    ApiCleanMixin, MaxLengthFileValidator, ApiBaseValidator
):
    message = f"The length of the text should be less {settings.API_VALID_MAX_FILE_LENGTH_TEXT}"


class ApiMinLengthFileValidator(
    ApiCleanMixin, MinLengthFileValidator, ApiBaseValidator
):
...
api_max_length_file_text = ApiMaxLengthFileValidator(
    settings.API_VALID_MAX_FILE_LENGTH_TEXT
)
api_min_length_file_text = ApiMinLengthFileValidator(
    settings.API_VALID_MIN_FILE_LENGTH_TEXT
)
